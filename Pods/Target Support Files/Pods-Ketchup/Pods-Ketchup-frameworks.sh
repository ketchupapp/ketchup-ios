...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/FSQCellManifest/FSQCellManifest.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/FSQMessageForwarder/FSQMessageForwarder.framework"
